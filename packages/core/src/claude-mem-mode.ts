...
export const SALESFORCE_DX_MODE: ClaudeMemMode = {
  name: 'salesforce-dx',
  description:
    'Captures Salesforce DX development observations — Apex patterns, deployment decisions, org config, MCP operations, security rules, and permission model choices.',
  version: '1.0.0',
  ...
  observation_types: [
    {
      ...
      label: 'Apex Pattern',
      description:
        'A reusable Apex design decision — service layer, trigger handler, selector, domain pattern, bulk handling approach, or async strategy.',
      emoji: '⚡',
      work_emoji: '🔨',
    },
    {
      ...
      description:
        'A deployment decision, validation error, test failure, coverage gap, or rollback action encountered during deployment.',
      emoji: '🚀',
      work_emoji: '🔧',
    },
    {
      ...
      description:
        'A decision about Permission Sets, Profiles, CRUD/FLS enforcement, sharing rules, or guest user access configuration.',
      emoji: '🔒',
      work_emoji: '🛡️',
    },
    {
      ...
      label: 'Org Config',
      description:
        'An org alias, scratch org definition, sandbox configuration, Connected App setting, Named Credential setup, or remote site setting.',
      emoji: '🏢',
      work_emoji: '⚙️',
    },
    {
      ...
      label: 'MCP Operation',
      description:
        'A Salesforce DX MCP tool use — org query, metadata retrieval, deployment via MCP, SOQL run, or LWC expert guidance call.',
      emoji: '🤖',
      work_emoji: '🔗',
    },
    {
      ...
      description:
        'A SOQL injection risk, missing CRUD/FLS check, sharing violation, exposed credential, guest user gap, or production safety concern.',
      emoji: '🚨',
      work_emoji: '🔍',
    },
    {
      ...
      label: 'LWC Decision',
      description:
        'A Lightning Web Component design choice — wire adapter selection, component decomposition, state management, Apex integration pattern, or UX state handling.',
      emoji: '⚡',
      work_emoji: '🎨',
    },
    {
      ...
      label: 'Test Strategy',
      description:
        'An Apex test design decision — test data strategy, mock approach, coverage gap fix, bulk test pattern, or security test scenario.',
      emoji: '🧪',
      work_emoji: '✅',
    },
    {
      ...
      description:
        'An Agentforce agent design decision — topic scope, invocable action design, Prompt Template approach, or AFV Library skill usage.',
      emoji: '🧠',
      work_emoji: '🤖',
    },
  ],
  ...
  prompts: {
    system_identity:
      'You are a senior Salesforce DX observer embedded in the development session. ' +
    ...
    spatial_awareness:
      'This is a Salesforce DX project. Source lives under force-app/. ' +
    ...
    observer_role:
      'Observe the development session and capture decisions that would be valuable to remember ' +
    ...
    recording_focus:
      'Focus on: Apex patterns (bulkification, service layer, trigger handler), ' +
    ...
    skip_guidance:
      'Skip: trivial variable renames, minor formatting changes, ' +
    ...
    type_guidance:
      'Use apex-pattern for any reusable Apex design decision. ' +
    ...
    concept_guidance:
      'Tag governor-limit for anything that could hit Apex limits. ' +
    ...
    field_guidance:
      'Include the org alias when known. ' +
...
export function generateClaudeMemModeJson(): string {
  return JSON.stringify(SALESFORCE_DX_MODE, null, 2) + '\n';
}
